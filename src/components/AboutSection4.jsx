      ...
      <div className={styles.frameGroup}>
        ...
        <div className={styles.mission}>
          ...
          <b className={styles.b}>
            <span className={styles.indent}></span>Миссия компании - внедрение концепции «Цифрового предприятия»<br />
            через создание единой экосистемы, связывающей идею<br />
            устройства с его физическим воплощением и<br />
            последующим сервисным<br />
            сопровождением.
          </b>
